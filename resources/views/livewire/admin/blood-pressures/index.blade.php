<div>
    ...
    <h1 class="text-2xl font-bold text-white mb-8">Blood Pressure Records</h1>
    ...
    <div class="bg-gray-900 border border-white/5 rounded-2xl overflow-hidden relative min-h-[400px]">
        ...
        <table class="w-full text-sm">
            ...
            <tr class="text-xs text-gray-500 border-b border-white/5 bg-gray-900/50">
                ...
                <th class="px-6 py-4 text-left font-medium tracking-wider">Sys/Dia (mmHg)</th>
                <th class="px-6 py-4 text-left font-medium tracking-wider">Pulse</th>
            ...
            @forelse($records as $record)
                <tr class="hover:bg-white/[0.02] transition-colors" wire:key="bp-{{ $record->id }}">
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-2.5 py-1 rounded-md text-sm font-bold border
                            {{ $record->systolic > 130 || $record->diastolic > 80 ? 'bg-orange-500/10 text-orange-400 border-orange-500/20' : 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' }}">
